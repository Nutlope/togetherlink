...
| Cheaper context estimation + trim (rough length first)                   | Less stringify on every request                                         | Low                                                         | Dedicated no-tools/context-heavy bench + error-path coverage     | Attempt failed; needs target bench        |
